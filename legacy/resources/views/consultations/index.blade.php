            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    <div class="text-muted mb-2" style="font-size: 0.95rem;">
                        <i class="fas fa-stethoscope fa-fw text-secondary"></i>{{ $doctor->doctorSpecialty->first()?->specialties?->name ?? 'General Practitioner' }}
                    </div>
                ...
                <div class="col-md-3 custom-border-left text-md-left text-center mt-3 mt-md-0 pl-md-4">
                    ...
                    <div class="text-md-right">
                        @auth
                        <a href="{{ route('member.chat') }}" class="btn btn-block text-white font-weight-bold py-2 shadow-sm" style="background-color: #ea580c; border-radius: 8px; transition: 0.3s;">
                            Chat
                        </a>
                        @endauth
